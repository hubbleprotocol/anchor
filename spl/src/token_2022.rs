...
pub fn get_account_data_size<'a, 'b, 'c, 'info>(
    ctx: CpiContext<'a, 'b, 'c, 'info, GetAccountDataSize<'info>>,
...
pub fn initialize_mint_close_authority<'a, 'b, 'c, 'info>(
    ctx: CpiContext<'a, 'b, 'c, 'info, InitializeMintCloseAuthority<'info>>,
...
pub fn initialize_immutable_owner<'a, 'b, 'c, 'info>(
    ctx: CpiContext<'a, 'b, 'c, 'info, InitializeImmutableOwner<'info>>,
) -> Result<()> {
...
pub fn amount_to_ui_amount<'a, 'b, 'c, 'info>(
    ctx: CpiContext<'a, 'b, 'c, 'info, AmountToUiAmount<'info>>,
    amount: u64,
) -> Result<String> {
...
pub fn ui_amount_to_amount<'a, 'b, 'c, 'info>(
    ctx: CpiContext<'a, 'b, 'c, 'info, UiAmountToAmount<'info>>,
    ui_amount: &str,
) -> Result<u64> {
